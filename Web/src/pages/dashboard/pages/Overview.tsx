      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-[#27B9BA] hover:bg-[#27B9BA]/10 px-3 py-1.5 rounded-lg text-sm font-medium transition">View all</button>
          </div>

          <div className="space-y-6">
            <div>
              <span className="inline-block px-3 py-1 text-xs font-medium bg-emerald-100 text-emerald-700 rounded-full">Graphic Design</span>
              <h4 className="font-semibold text-gray-900 mt-3">Visual Graphic for Client Presentation</h4>
              <div className="mt-4">
            ...
            <div>
              <span className="inline-block px-3 py-1 text-xs font-medium bg-purple-100 text-purple-700 rounded-full">Development</span>
              <h4 className="font-semibold text-gray-900 mt-3">Build Database Design for AutoFix v2</h4>
              <div className="mt-4">
                <div className="flex justify-between text-sm text-gray-600 mb-2">
                  <span>Progress</span>
            ...
            <div>
              <span className="inline-block px-3 py-1 text-xs font-medium bg-[#27B9BA]/10 text-[#27B9BA] rounded-full">Marketing</span>
              <h4 className="font-semibold text-gray-900 mt-3">Launch AutoFix Campaign Q4</h4>
              <div className="mt-4">
                <div className="flex justify-between text-sm text-gray-600 mb-2">
                  <span>Progress</span>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-[#27B9BA] hover:bg-[#27B9BA]/10 px-3 py-1.5 rounded-lg text-sm font-medium transition">See all</button>
          </div>

          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-linear-to-br from-[#27B9BA] to-[#1e9a9b] rounded-xl flex items-center justify-center text-white font-bold text-lg shrink-0">K</div>
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-linear-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center text-white font-bold text-lg shrink-0">E</div>
              <div className="flex-1">
            ...
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-linear-to-br from-orange-500 to-red-500 rounded-xl flex items-center justify-center text-white font-bold text-lg shrink-0">A</div>
              <div className="flex-1">
